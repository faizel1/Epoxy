...
const Navbar = () => {
    ...
    return (
        ...
        <header className='max-w-[100%] 2xl:max-w-[1920px] overflow-hidden mx-auto' >
            <motion.nav
               initial="closed"
               animate={ "open"}
            ...
            >
                ...
                <div className={`${menuOpen ? "pl-10 pr-4" : "px-4"} flex justify-between items-center py-4 sm:px-10 md:px-10 lg:pl-40 2xl:pl-40  mx-auto 2`}>
                    ...
                    <Link href={"/"}>
                        <Image src="/img/Logo.jpg" className='w-28 h-auto' width={100} height={50} alt="Logo" />    
                    ...
                    <div className="flex items-center">
                        ...
                        <ul className="md:flex space-x-4 md:space-x-14 hidden items-center">
                            ...
                            <Link className={` hover:text-[#F58A07] text-md md:text-xl font-bold ${currentRoute === '/about-us' ? 'text-[#F58A07]' : 'text-[#394149]'} `} href={"/about-us"}>About Us </Link>
                            <Link className={` hover:text-[#F58A07] text-md md:text-xl font-bold ${currentRoute === '/gallery' ? 'text-[#F58A07]' : 'text-[#394149]'} `} href={"/gallery"}>Gallery</Link>
                            <Link className={` hover:text-[#F58A07] text-md md:text-xl font-bold ${currentRoute === '/contact-us' ? 'text-[#F58A07]' : 'text-[#394149]'} `} href={"/contact-us"}>Contact Us</Link>
                        </ul>
                        ...
                        >
                            ...
                            <Image src={`${menuOpen ? "/img/close.png" : "/img/open.png"}`} width={30} height={30} alt='menu' />
                        </div>
                    </div>
            ...
            <motion.nav
                className={`${menuOpen ? 'flex flex-col h-[calc(100vh-80px)] pl-10 pr-5 ' : 'hidden'} md:hidden min-h-[calc(100vh-80px)] ease-in-out transition-transform`}
